...
public class MembersService {
	...
	public boolean validateUser(String memId, String memPassword) throws Exception {
		...
		try {
			count = em
					.createQuery("select count(m) from User m where m_id = :m_id and m_password = :m_password",
							Long.class)
					.setParameter("m_id", memId).setParameter("m_password", memPassword).getSingleResult();
	...
	// 본인 프로필 수정
	public static boolean memUpdate(String id, String pw, String name, String email, String profile, String grade)
			throws SQLException {
		EntityManager em = DBUtil.getEntityManager();
		EntityTransaction tx = em.getTransaction();
		Members mem = null;
...
//				mem.setGrade();
	...
	public MembersDTO loginMember(String memId, String password) throws SQLException {
		...
		try {
			...
			MembersDTO loginData = (MembersDTO) em.createNamedQuery("Members.findByLoginInfo")
					.setParameter("memId", memId).setParameter("password", password).getSingleResult();
	...
	public Members findId(String email) throws SQLException {
		...
		try {
			...
			members = (Members) em.createNamedQuery("Members.findByEmail").setParameter("email", email)
					.getSingleResult();
	...
	public Members findPwd(String id, String email) throws SQLException {
		...
		try {
			...
			members = (Members) em.createNamedQuery("Members.findPassword").setParameter("id", id)
	...
	// 관리자 프로필 수정
	public static boolean adminUpdate(String id, String pw, String name, String email, String profile, String grade)
			throws SQLException {
		EntityManager em = DBUtil.getEntityManager();
		EntityTransaction tx = em.getTransaction();
		Members mem = null;

            ...
            <body>
                ...
                <nav class="navbar navbar-expand-lg bg-body-tertiary shadow">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <a href="../cart/cart.html" class="nav-item nav-link"><i class="fa fa-shopping-cart"
                        ...
                        <div class="row g-6">
                            <div class="col-lg col-md">
                                <div class="flex">
                                    ...
                                    <a class="info" href="../about.html" class="text-primary align-items-right">사이트소개<i
                                            class="fa fa-arrow-right ms-3"></i></a>
                                </div>
                                <p class="mb-2"><i class="fa fa-map-marker-alt me-10"></i> 서울시 강남구 강남대로 420 역삼빌딩 1205호
                                </p>

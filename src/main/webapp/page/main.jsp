...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary shadow">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="../page/lecture/lectures.html" class="nav-item nav-link">강의</a> &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="../page/community/community.html" class="nav-item nav-link">커뮤니티</a> &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="../page/notice/notice.html" class="nav-item nav-link">공지사항</a> &nbsp;&nbsp;&nbsp;&nbsp;
            <!-- 세션ID 존재할 경우 나오는 메뉴 Start-->
            <a href="cart.html" class="nav-item nav-link"><i class="fa fa-shopping-cart" style="font-size:24px;color:#06BBCC"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">My Pages&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
            <div class="dropdown-menu fade-down">
                <a href="myinfo.html" class="dropdown-item">내 정보</a>
                <a href="mylecture.html" class="dropdown-item">내 강의</a>
                <a href="#" class="dropdown-item">메뉴</a>
                <a href="teachers/teacherInsertForm.html" class="dropdown-item">강사 신청</a>

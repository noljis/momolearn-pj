	            ...
	            <div class="owl-carousel-item position-relative">
	                ...
	                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
	                    <div class="container">
	                        <div class="row justify-content-start">
	                            <div class="col-sm-10 col-lg-8">
	                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">스프링을 배워보고 싶으시다고요?</h5>
	                                ...
	                                <a href="${pageContext.request.contextPath}/lectures/detail/3" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">스프링 입문강의 들으러가기➡️</a>
	                            </div>
	                        </div>
	                    </div>
	                </div>

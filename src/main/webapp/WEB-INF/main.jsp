						...
						<div class="container">
							<div class="row justify-content-start">
								<div class="col-sm-10 col-lg-8">
									<h5
										class="text-primary text-uppercase mb-3 animated slideInDown">왜
										모모런인가?</h5>
									<h1 class="display-5 text-white animated slideInDown">오직
										모모런에서만 만날 수 있는 강의!</h1>
					...
					<div
						...
						<div class="container">
							<div class="row justify-content-start">
								<div class="col-sm-10 col-lg-8">
									<h5
										class="text-primary text-uppercase mb-3 animated slideInDown">입문자
										강의</h5>
									<h1 class="display-3 text-white animated slideInDown">누구나
										입문할 수 있다는 문구</h1>
					...
					<div
						...
						<div class="container">
							<div class="row justify-content-start">
								<div class="col-sm-10 col-lg-8">
									<h5
										class="text-primary text-uppercase mb-3 animated slideInDown">이달의
										신규강의</h5>
									<h1 class="display-3 text-white animated slideInDown">남궁성
										강사님 모모런 도착!</h1>
